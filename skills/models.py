...
class Profile(models.Model):
    ...
    gmail_logo = models.ImageField(null=True, blank=True, upload_to='gmail_logo/')
    brand_logo = models.ImageField(null=True, blank=True, upload_to='brand_logo/')
    favicon = models.ImageField(null=True, blank=True, upload_to='favicon/')
